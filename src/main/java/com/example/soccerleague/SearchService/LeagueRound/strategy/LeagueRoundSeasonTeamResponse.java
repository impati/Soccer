...
@Data
public class LeagueRoundSeasonTeamResponse extends DataTransferObject {
    private String name;
    private String type;
    private int rank;
    ...
    public static LeagueRoundSeasonTeamResponse create(String name,String type){
        LeagueRoundSeasonTeamResponse obj = new LeagueRoundSeasonTeamResponse();
        obj.setName(name);
        obj.setType(type);
        return obj;
    }
